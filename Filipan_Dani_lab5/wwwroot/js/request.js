...
function displayEditForm(id) {
    ...
    document.getElementById('edit-isApproved').checked = item.isApproved;
...
function updateItem() {
    ...
    const item = {
        ...
        isApproved: document.getElementById('edit-isApproved').checked,
...
function _displayCount(itemCount) {
    const name = (itemCount === 1) ? 'budget item' : 'budget items';
...
function _displayItems(data) {
    ...
    data.forEach(item => {
        let isApprovedCheckbox = document.createElement('input');
        isApprovedCheckbox.type = 'checkbox';
        isApprovedCheckbox.disabled = true;
        isApprovedCheckbox.checked = item.isApproved;
        ...
        td1.appendChild(isApprovedCheckbox);
